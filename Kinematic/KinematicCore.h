...
public:
  ...
  std::vector<double> getJointLocalOri(int id) const;
  std::vector<double> getJointOmg(int id) const;
  std::vector<double> getJointLocalOmg(int id) const;
  ...
  std::vector<double> getJointGlobalPoses(const std::vector<int>& ids) const;
