...
public:
  ...
  Eigen::Vector3d getJointAttach(int id) const;
  Eigen::Quaterniond getJointThetaAttach(int id) const;
  Eigen::Vector3d getJointRevoluteAxis(int id) const;
  Eigen::Vector3d getBodyAttach(int id) const;
